...
switch (icon) {
    ...
    case 2:
        ...
        PlaySoundSingle("sndRingMonitor", global.volumeSounds, 1);
        break;
    ...
    case 5:
        with (ownerID) {
            PlayerAddEnergy(80);
            PlaySoundSingle("sndTrick", global.volumeSounds, 1);
        }
        break;
    ...
    case 6:
        with (ownerID) {
            ...
            PlaySoundSingle("sndShieldMonitor", global.volumeSounds, 1);
        }
        break;
    ...
    case 7:
        with (ownerID) {
            ...
            PlaySoundSingle("sndShieldMonitor", global.volumeSounds, 1.1);
        }
        break;
    ...
    case 10:
        ...
        PlaySoundSingle("sndRingMonitor", global.volumeSounds, 0.75);
        break;
}
