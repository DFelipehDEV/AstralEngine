...
if (ground) {
    _xAcceleration = xAcceleration * sysTime.timeScale;
    _xFriction = xFriction * sysTime.timeScale;
    _xBrakeFriction = (xFriction * 1.7) * sysTime.timeScale;
} else {
    _xAcceleration = xAirAcceleration * sysTime.timeScale;
    _xFriction = 0;
    _xBrakeFriction = 0;
}
