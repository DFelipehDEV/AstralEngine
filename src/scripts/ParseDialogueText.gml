        ...
        if (_c == ']') {
            ...
            if (_actionPos != 0) {
                ...
                if (joystick_exists(0)) {
                    _actionFrame = ds_list_find_value(ds_map_get(objWorld.buttonInputIcons, _actionName), 1);
                    ...
                    _actionFrame = ds_list_find_value(ds_map_get(objWorld.keyInputIcons, _actionName), 1);
